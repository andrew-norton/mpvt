...
Download a ZIP of this repository, extract and save it anywhere you'd like. Open up the folder it saved to, right click ```main.py``` and open with Python, and wait for it to do it's thing (could take 30 seconds to 2 minutes). 
